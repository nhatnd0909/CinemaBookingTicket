                    ...
                    $(document).ready(function() {
                        ...
                        var sc = $('#seat-map').seatCharts({
                            ...
                            click: function() { //Click event
                                if (this.settings.id === '8_5' || this.settings.id === '8_6' || this.settings.id === '8_7' || this.settings.id === '8_8' || this.settings.id === '7_5' || this.settings.id === '7_6' || this.settings.id === '7_7' || this.settings.id === '7_8') {
                                    if (this.status() == 'vip') {
