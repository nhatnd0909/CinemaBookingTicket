...
<<<<<<< HEAD:src/main/webapp/WEB-INF/views/admin/movieDashboard.jsp
pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
  <head>
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          ...
          >
            <a class="navbar-brand brand-logo-mini" href="adminDashboard.html"
              ><img src="admin_assets/assets/images/logo-mini.svg" alt="logo"
            /></a>
          </div>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img
                        src="admin_assets/assets/images/faces/face4.jpg"
                        alt="image"
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img
                        src="admin_assets/assets/images/faces/face2.jpg"
                        alt="image"
                        class="rounded-circle profile-pic"
                      />
                    </div>
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img
                        src="admin_assets/assets/images/faces/face3.jpg"
                        alt="image"
                        class="rounded-circle profile-pic"
                      />
                    </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <img
                                ...
                                alt="image"
                              />
                              <span class="pl-2">Ác Quỷ Ma Sơ 2</span>
                            </td>
                            <td>02312</td>
                            <td>$14,500</td>
                            <td>$14,500</td>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group">
                      <label for="exampleInputName1">Name Movie</label>
                      <input
                        type="text"
                        class="form-control"
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail3">Trailer URL</label>
                      <input
                        type="email"
                        class="form-control"
										...
										<table class="table">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<div class="badge badge-outline-success">
															<a href="<c:url value='/rankDashboard/update/${rank.rankID}'/>" style="text-decoration: none; color: inherit;" >
																<i class="mdi mdi-eye"></i>
															</a>
														</div>
														<div class="badge badge-outline-success">
															<a  onclick="deleteRank(${rank.rankID});" type="submit"  style="text-decoration: none; color: inherit;" >
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response === 'Xóa thành công') {
                            ...
                            setTimeout(function() {
								window.location.href = '/rankDashboard';
							}, 1000);
                        } else {
...
>>>>>>> c6f56aad482ecb9f3532159efd86b9cd38b5e087:bin/src/main/webapp/WEB-INF/views/admin/rank/rankDashboard.jsp
