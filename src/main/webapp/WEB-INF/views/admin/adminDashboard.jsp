                  ...
                  <div class="card-body">
                    ...
                    <div class="preview-list">
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img
                            src="admin_assets/assets/images/faces/face6.jpg"
                            alt="image"
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img
                            src="admin_assets/assets/images/faces/face8.jpg"
                            alt="image"
                            class="rounded-circle"
                          />
                        </div>
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img
                            src="admin_assets/assets/images/faces/face9.jpg"
                            alt="image"
                            class="rounded-circle"
                          />
                        </div>
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img
                            src="admin_assets/assets/images/faces/face11.jpg"
                            alt="image"
                            class="rounded-circle"
                          />
                        </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    >
                      <div class="item">
                        <img
                          src="admin_assets/assets/images/dashboard/Rectangle.jpg"
                          alt=""
                        />
                      </div>
                      <div class="item">
                        <img
                          src="admin_assets/assets/images/dashboard/Img_5.jpg"
                          alt=""
                        />
                      </div>
                      <div class="item">
                        <img
                          src="admin_assets/assets/images/dashboard/img_6.jpg"
                          alt=""
                        />
                      </div>
                    </div>
                    <div class="d-flex py-4">
                      <div class="preview-list w-100">
                        <div class="preview-item p-0">
                          <div class="preview-thumbnail">
                            <img
                              src="admin_assets/assets/images/faces/face12.jpg"
                              class="rounded-circle"
                              alt=""
                            />
                          </div>
