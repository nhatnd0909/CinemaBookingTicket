						...
						<div class="card">
							<div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="mb-0"><a href="/employeeDashboard" style="text-decoration: none; color: inherit;"> Nhân Viên</a> / <span>Cập Nhật</span></p>
                                </div>
								<form class="forms-sample" method="post" action="/employeeDashboard/update/${employee.employeeID}">
									...
									<div class="form-group">
										<label for="allTheaters">Chọn một rạp khác</label>
