        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          ...
          >
            <a class="navbar-brand brand-logo-mini" href="adminDashboard.html"
              ><img
                src="../admin_assets/assets/images/logo-mini.svg"
                alt="logo"
            /></a>
          </div>
                  ...
                  <div class="card-body">
                    ...
                    >
                      ...
                      <div class="mb-0 icon icon-box-success">
                        <a
                          href="<c:url value='/movieDashboard/create' />"
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="badge badge-outline-success">
                                  <a
                                    href="<c:url value='/movieDashboard/update/${movie.movieID}'/>"
                                    style="
                                ...
                                <a
                                  class="h4 mr-3"
                                  href="<c:url value='/admin/movies/edit/${movie.movieID}' />"
                                  >Edit</a
                                >
                                <a
                                  class="h4"
                                  href="<c:url value='/admin/movies/delete/${movie.movieID}' />"
                                  >Delete</a
                                >
                                --%>
                              </td>
