								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<p class="mb-0">
										<a href="/movieDashboard"
											style="text-decoration: none; color: inherit;"> Phim</a> / <span>Cập Nhật</span>
									</p>
								</div>
								<form class="forms-sample" method="post"
									action="/movieDashboard/update/${movie.movieID}">
									...
									<div class="form-group">
										<label for="exampleInputEmail3">Ngày Kết Thúc</label> <input
											type="date" class="form-control" id="exampleInputEmail3"
