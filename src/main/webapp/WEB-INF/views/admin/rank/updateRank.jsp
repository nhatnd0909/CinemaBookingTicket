					...
					<div class="profile-desc">
						...
						<div
							...
							<a href="/adminDashboard/changepassword" class="dropdown-item preview-item">
								...
								<div class="preview-item-content">
									<p class="preview-subject ellipsis mb-1 text-small">Thay Đổi Tài Khoản</p>
								</div>
							</a>
					</div>
				</li>
						...
						<div class="card">
							<div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h4 class="card-title">Cập Nhật Thứ Hạng</h4>
                                    <p class="mb-0"><a href="/rankDashboard" style="text-decoration: none; color: inherit;"> Thứ Hạng</a> / <span>Cập Nhật </span></p>
                                </div>
