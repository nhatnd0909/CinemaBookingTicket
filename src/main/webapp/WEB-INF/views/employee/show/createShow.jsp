						...
						<div class="card">
							<div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h4 class="card-title">Add New Show</h4>
                                    <p class="mb-0"><a href="/employee/show" style="text-decoration: none; color: inherit;"> Show</a> / <span>New Show</span></p>
                                </div>
								<form class="forms-sample" method="post" action="">
									<div class="form-group">
										<label for="exampleInputName1">Star Time</label> 
                                        <input type="date" class="form-control" id="exampleInputName1" placeholder="Name" name=""  required="required">
									</div>
									<div class="form-group">
										<label for="exampleInputEmail3">Price</label> 
                                        <input type="email" class="form-control" id="exampleInputEmail3" placeholder="Price" name=""  required="required">
									</div>
                                    <div class="form-group">
										<label for="exampleSelectGender">Name Moive</label> <select class="form-control" id="exampleSelectGender">
                                    ...
                                    <div class="form-group">
										<label for="exampleSelectGender">Name Room</label> <select class="form-control" id="exampleSelectGender">
