...
<body>
						...
						<div class="card">
							<div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="mb-0"><a href="/employee/service" style="text-decoration: none; color: inherit;"> Dịch Vụ</a> / <span>Cập Nhật Dịch Vụ</span></p>
                                </div>
    ...
    <script src="/admin_assets/assets/javascripts/employeeService.js"></script>
