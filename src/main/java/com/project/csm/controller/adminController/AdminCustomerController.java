...
public class AdminCustomerController {
    ...
    public String showCustomerAdmin(Model model, @RequestParam(defaultValue = "0") int page) {
	    ...
	    List<Customer> pagedCustomers = allCustomers.subList(page * pageSize, Math.min((page + 1) * pageSize, allCustomers.size()));
	...
	public String updateAccountCustomer(
