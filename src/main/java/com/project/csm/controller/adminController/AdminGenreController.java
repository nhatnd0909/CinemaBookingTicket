...
public class AdminGenreController {
	...
	public String createGenreAdmin(Model model) {

		return "admin/genre/createGenre";
	}
	
	@PostMapping("/genreDashboard/create")
	public String postCreateGenreAdmin(@ModelAttribute Genre genre, Model model) {
		genreService.createGenre(genre);
		return "redirect:/genreDashboard";
	}
	@GetMapping("/genreDashboard/update/{genreId}")
	public String getUpdateGenre(@PathVariable Long genreId, Model model) {
	...
	public String postUpdateGenre( @PathVariable Long genreId,@ModelAttribute Genre genres ) {
